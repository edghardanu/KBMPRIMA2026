...
export default function PengurusMateriPage() {
    ...
    useEffect(() => {
        ...
        const fetchRecap = async () => {
            ...
            // Fetch all target_materi logs and supporting data for mapping
            const [targetMateriRes, muridRes, materiRes] = await Promise.all([
                ...
                supabase.from('murid').select('id, nama').eq('jenjang_id', selectedJenjang),
            ...
            // Fetch materi count for completion requirement
